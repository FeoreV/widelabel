...
export class CdekAuthClient {
  ...
  constructor(
    clientId: string = process.env.CDEK_CLIENT_ID || "test_cdek_id",
    clientSecret: string = process.env.CDEK_CLIENT_SECRET || "test_cdek_secret",
  ...
  public async getAccessToken(): Promise<string> {
    ...
    const data: CdekTokenResponse = await response.json();
